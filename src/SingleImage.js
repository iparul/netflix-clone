...
function SingleImage({
  ...
  const romoveMovie = (movie) => {
    let ans = removeFromList(movie);
    myList = [];
  };
  useEffect(() => {
    generateRandom();
  ...
  return (
    ...
    >
      ...
      {isHovered && (
        <div className={`hover ${isLargeRow && "hover_posterLarge"}`}>
          <div
            className={`image-video-container ${
              isLargeRow && "image-video-container_posterLarge"
            }`}
          >
            <img
          ...
          <div className="row_info_container">
            <h3 className="row_name" onClick={() => navigate("/player")}>
            ...
            <div className="row_info">
              <div className="row_controls">
                ...
                />
                <RiThumbUpFill title="Like" className="IoPlayCircleSharp" />
                <RiThumbDownFill
                  title="Dislike"
                  className="IoPlayCircleSharp"
                />
